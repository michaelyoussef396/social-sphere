...
const Hero = () => {
  ...
  return (
    <div
      className="hero-container relative h-screen w-full overflow-hidden"
      id="hero"
    >
      <ImagesSlider
        images={images}
      ...
      >
        <div className="absolute inset-0 z-50 flex flex-col justify-center items-center text-white px-4 md:px-0">
          ...
          <p className="font-cormorant text-lg md:text-xl mt-4 max-w-2xl mx-auto text-center text-cream">
            ...
            experiences. Let us bring your vision to life with elegance, style,
            and seamless execution.
          </p>
          <a
            href="#services"
            className="mt-6 inline-block bg-gold hover:bg-green text-black text-lg font-cormorant font-medium py-3 px-8 rounded-lg transition duration-300"
          >
